...
void main(){
  final dose = calculateDose(dosePerTablet: 500, frequencyPerDay: 2, drugName: 'Metformin');
print(dose);
}

calculateDose({required String drugName, required int dosePerTablet, required int frequencyPerDay,int durationDays = 7}){
